...
@Component({
  ...
  providers: [
    CollectionService,
    { provide: 'API_SERVICE', useValue: 'get-promotions' },
    CommonApiService,
    CommonVerbsApiService
  ],
})
export class ListComponent   extends CollectionComponent<ProductPromotion>{
  breadCrumbs = [
  ...
  constructor(
    ...
    service: CollectionService<ProductPromotion>,
  ...
  delete(id: string) {
    Swal.fire({
      ...
      if (result.value) {
        this.api2.delete(`promotions/${id}`).subscribe(
          () => {
