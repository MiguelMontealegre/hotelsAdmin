...
export class EditFormComponent
  ...
  //Hotelss
  listHotelSearch = false;
  allHotels: Category[];
  hotelSearch = null;
  hotelsPage = 1;
  totalHotels: number;
  hotelsPerPage: number;
  private getHotels = debounce(
    () => {
      this.api2
        .get<PaginatedCollection<Category>>(
          'hotels',
          {
            page: this.hotelsPage,
            limit: 10,
            orderBy: 'createdAt',
            direction: 'DESC',
            q: this.hotelSearch,
        ...
        .subscribe(r => {
          this.allHotels = r.data;
          this.totalHotels = r.meta.total;
          this.hotelsPerPage = r.meta.per_page;
        });
    },
    500,
    {}
  );
  onListHotelSearch(q: any) {
    this.hotelsPage = 1;
    this.hotelSearch = q.term.toLowerCase();
    this.listCatSearch = true;
    this.getHotels();
  }
  onHotelsPageChange(e: any) {
    this.hotelsPage = e;
    this.listCatSearch = true;
    this.getHotels();
  }
